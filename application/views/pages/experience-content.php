<div class="project-card">
    ...
    <ul>
        ...
        <li>Gaining hands-on experience in secure, enterprise-grade ICT environments.</li>
    </ul>
</div>
...
<div class="project-card">
    ...
    <ul>
        ...
        <li>Assisted in research planning, manuscript preparation, and deadline tracking.</li>
        <li>Collaborated in cross-functional teams using Agile-style coordination.</li>
    </ul>
</div>